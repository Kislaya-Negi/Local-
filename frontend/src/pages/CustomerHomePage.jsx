    ...
    <div className="section">
      <div className="card">
        <div className="vendor-meta">
          <div>
            <div className="title" style={{ fontSize: 18 }}>Browse vendors</div>
            <div className="subtitle">Search from the top bar and narrow results with the category dropdown.</div>
          </div>
          <span className="badge green">{filteredVendors.length} matches</span>
        </div>
