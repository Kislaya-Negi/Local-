      ...
      <div className="card">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 }}>
          <div>
            ...
            <div className="subtitle">Review incoming cart orders, service requests, and in-app chats.</div>
          </div>
          <button
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center", flexWrap: "wrap" }}>
                      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                        ...
                        <div className="vendor-sub">{r.customer?.location || "-"}</div>
                      </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div className="card">
            <form onSubmit={addProduct} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <Field label="Name">
                <input className="input" value={pName} onChange={(e) => setPName(e.target.value)} placeholder="Ceramic vase" />
              </Field>
              <div className="row">
                <div style={{ flex: 1 }}>
                  <Field label="Price">
                    <input className="input" value={pPrice} onChange={(e) => setPPrice(e.target.value)} placeholder="1200" />
                  </Field>
                </div>
                <div style={{ flex: 2 }}>
                  <Field label="Description (optional)">
                    <input className="input" value={pDesc} onChange={(e) => setPDesc(e.target.value)} placeholder="Handmade, locally sourced..." />
                  </Field>
                </div>
              </div>
